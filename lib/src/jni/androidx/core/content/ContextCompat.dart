...
class ContextCompat extends _$jni.JObject {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static _$jni.JArray<file_.File> getObbDirs(
    context_.Context context,
  ) {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static _$jni.JArray<file_.File> getExternalFilesDirs(
    context_.Context context,
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static _$jni.JArray<file_.File> getExternalCacheDirs(
    context_.Context context,
  ) {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static _$jni.JObject registerReceiver(
    context_.Context context,
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static _$jni.JObject registerReceiver$1(
    context_.Context context,
    _$jni.JObject broadcastReceiver,
    _$jni.JObject intentFilter,
    _$jni.JString string,
