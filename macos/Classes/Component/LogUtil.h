 ...
 *  Module Logging
 */
#define LOG_FATAL(module, format, ...) LogInternal(kLevelFatal, module, __FILENAME__, __LINE__, __FUNCTION__, @"Fatal:", format, ##__VA_ARGS__)
...
#define LOG_VERBOSE(module, format, ...) LogInternal(kLevelVerbose, module, __FILENAME__, __LINE__, __FUNCTION__, @"Verbose:", format, ##__VA_ARGS__)
